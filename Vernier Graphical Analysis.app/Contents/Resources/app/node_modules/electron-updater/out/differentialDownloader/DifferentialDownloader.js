...
class DifferentialDownloader {
    ...
    downloadFile(tasks) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const oldFileFd = yield (0, (_fsExtraP || _load_fsExtraP()).open)(_this.options.oldPackageFile, "r");
            yield new (_bluebirdLst2 || _load_bluebirdLst2()).default(function (resolve, reject) {
                ...
                const fileOut = (0, (_fsExtraP || _load_fsExtraP()).createWriteStream)(_this.options.newFile);
                ...
                const w = function (taskOffset) {
                    if (taskOffset >= tasks.length) {
                        firstStream.end(_this.fileMetadataBuffer);
                        return;
                    }
